...
unique_numbers: set = set(list_)
sum_of_numbers: int = sum(unique_numbers)
count_of_numbers: int = len(unique_numbers)
average_of_numbers: int = round(sum_of_numbers / count_of_numbers, 5)
